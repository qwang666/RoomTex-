...
class StableDiffusionProcessingImg2Img(StableDiffusionProcessing):
    ...
    def __post_init__(self):
        ...
        self.image_mask = self.mask[0]
        self.latent_mask = self.mask[1]
        self.mask = None
    ...
    def init(self, all_prompts, all_seeds, all_subseeds):
        ...
        latent_mask = create_binary_mask(latent_mask)
        ...
        if image_mask is not None:
            ...
            self.lat_mask = torch.asarray(1.0 - latmask).to(shared.device).type(self.sd_model.dtype)
            self.lat_nmask = torch.asarray(latmask).to(shared.device).type(self.sd_model.dtype)
            ...
            if self.inpainting_fill == 2:
                ...
                self.init_latent = self.init_latent * self.lat_mask
