...
## Generate object mesh from Shap-E

Object mesh can be generated by using the script from Shap-E.

https://github.com/openai/shap-e/blob/main/shap_e/examples/sample_text_to_3d.ipynb 

One may change the text prompt as they want or directly cut out the furniture items from the panorama description.
