...
from utils.cameras.utils.math import Gaussians, conical_frustum_to_gaussian
...
class Frustums(TensorDataclass):
    ...
    def get_gaussian_blob(self) -> Gaussians:
        ...
        cone_radius = torch.sqrt(self.pixel_area) / \
            1.7724538509055159  # r = sqrt(pixel_area / pi)
        if self.offsets is not None:
...
class RayBundle(TensorDataclass):
    ...
    def set_camera_indices(self, camera_index: int) -> None:
        ...
        """
        self.camera_indices = torch.ones_like(
            self.origins[..., 0:1]).long() * camera_index
    ...
    def get_ray_samples(
        ...
        spacing_starts: Optional[TensorType["bs":...,
                                            "num_samples", 1]] = None,
        spacing_ends: Optional[TensorType["bs":..., "num_samples", 1]] = None,
        spacing_to_euclidean_fn: Optional[Callable] = None,
    ) -> RaySamples:
        ...
        ray_samples = RaySamples(
            ...
            # [..., 1, 1]
            times=None if self.times is None else self.times[..., None],
        )
